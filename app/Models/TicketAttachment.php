...
use Illuminate\Database\Eloquent\Relations\BelongsTo; // typehint voor belongsTo relatie
use Illuminate\Support\Facades\Storage; // nodig om publieke URL's te genereren
class TicketAttachment extends Model // model voor ticketbijlagen
{

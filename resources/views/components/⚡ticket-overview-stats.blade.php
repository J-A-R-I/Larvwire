...
<div class="mt-6 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-gray-200">
    {{-- wrapper rond het statistiekenblok --}}
    <div class="mb-4"> {{-- titelblok --}}
        ...
        <p class="mt-1 text-sm text-gray-600"> {{-- subtitel --}}
            Deze cijfers verversen automatisch wanneer comments, notities of
            bestanden wijzigen. {{-- subtiteltekst --}}
        </p>
    </div>
    <div class="grid gap-4 md:grid-cols-4"> {{-- grid met vierstatistiekkaarten --}}

        ...
        <form wire:submit="save" class="space-y-4">
            ...
            <div class="flex items-center gap-4">
                <button
                    ...
                    wire:target="save"
                    class="inline-flex items-center rounded-lg bg-blue-600 px-5 py-3 text-sm
                    ...
                    <div class="mb-3 flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
                        ...
                        <button
                            ...
                            class="inline-flex items-center rounded-lg bg-red-600 px-3 py-2 text-xs
                             font-semibold text-white shadow-sm transition hover:bg-red-700 disabled:cursor-not-allowed
                              disabled:opacity-50">
                            Verwijderen
                        </button>
                    </div>

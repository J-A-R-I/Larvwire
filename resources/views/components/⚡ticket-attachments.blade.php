...
class extends Component
{
    ...
    public function save(): void
    {
        $validated = $this->validate(
            [
                'file' =>
                    'required|file|max:5120|mimes:jpg,jpeg,png,pdf,txt,log,doc,docx',
            ],
            [
...
<div class="mt-6 space-y-6">
    ...
    <div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-gray-200">
        ...
        <form wire:submit="save" class="space-y-4">
            <div>
                ...
                <input
                    ...
                    class="block w-full rounded-lg border border-gray-300 bg-white px-4 py-3
                     text-sm shadow-sm file:mr-4 file:rounded-md file:border-0 file:bg-blue-50 file:px-4 file:py-2
            ...
            <div wire:loading wire:target="file" class="text-sm text-gray500">
            ...
            <div class="flex items-center gap-4">
                <button
                    ...
                    px-5 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-blue-700
...
{{ $this->attachments->count() }} item(s)
        ...
        <div class="space-y-4">
            @forelse ($this->attachments as $attachment)
                <div class="rounded-xl border border-gray-200 bg-gray-50 p4">
                    <div class="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                        <div class="min-w-0 flex-1">
                            <div class="flex flex-wrap items-center gap-3">
                                ...
                                @endif
                                <span class="text-xs text-gray-500"> {{ $attachment->created_at->format('d/m/Y H:i') }}
                                </span>
                            </div>
                            ...
                            <div class="mt-1 text-sm text-gray-500">
                                ...
                                type' }} • {{ $attachment->formattedFileSize() }}
                            </div>
                            <div class="mt-3">
                                <a
                                    href="{{ $attachment->url() }}"
                                    target="_blank"
                                    class="inline-flex items-center rounded-lg border border-blue-300 bg-blue-50 px-3 py-2
                                     text-xs font-medium text-blue700 transition hover:bg-blue-100">
                                    Open bestand
                                </a>
                            </div>
                        </div>

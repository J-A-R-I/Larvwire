...
public function sortBy(string $field): void
{
    ...
    if ($this->sortField === $field) {
        $this->sortDirection = $this->sortDirection === 'asc' ? 'desc' :
            'asc'; // toggle richting als je op dezelfde kolom klikt
    } else {
    ...
    <div class="mx-auto max-w-7xl px-4">
        <div class="mb-8 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <a
                ...
                class="inline-flex items-center rounded-lg bg-blue-600 px-5
                py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-blue-700">
                Nieuw ticket
            </a>
        </div>
            ...
            <div class="grid gap-4 md:grid-cols-3">
                <div>
                    ...
                    <input
                        ...
                        py-3 text-sm shadow-sm focus:border-blue-500 focus:outline-none focus:ring-2
                        focus:ring-blue-500"
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <th class="px-6 py-4 text-left text-xs font-
semibold uppercase tracking-wider text-gray-600">
                        ...
                        <tr wire:key="ticket-{{ $ticket->id }}"
                            ...
                            <td class="whitespace-nowrap px-6 py-4 text-sm">
                                @if ($ticket->priority === 'low')
                                    <span class="inline-flex rounded-full
                                    bg-gray-100 px-3 py-1 text-xs font-semibold text-gray-700">
                                        Laag
                                    </span>

...
session()->flash('success', 'De status van het ticket werd succesvol
aangepast.'); // toon feedback bovenaan
}
...
session()->flash('success', "{$count} ticket(s) werden op gesloten
gezet."); // toon succesfeedback
}
...
<div class="min-h-screen bg-gray-100 py-10">
    <div class="mx-auto max-w-7xl px-4">
            ...
            <div class="grid gap-4 md:grid-cols-4">
                ...
                <div>
                    ...
                    <select
                        ...
                        class="w-full rounded-lg border border-gray-300 px-4 py-3 text-sm shadow-sm
                         focus:border-blue-500 focus:outline-none focus:ring-2focus:ring-blue-500"
                    >
            ...
            <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                ...
                <div class="flex flex-wrap items-center gap-3">
                    <button
                        ...
                        class="inline-flex items-center rounded-lg border border-gray-300 bg-white px-4
                         py-2 text-sm font-medium text-gray-700 shadow-sm transition hover:bg-gray-50"
                    >
                    ...
                    <button
                        ...
                        class="inline-flex items-center rounded-lg bg-green-600 px-4 py-2 text-sm
                    ...
                    <button
                        ...
                        class="inline-flex items-center rounded-lg bg-red-600 px-4 py-2 text-sm
        ...
        <div class="overflow-hidden rounded-2xl bg-white shadow-sm ring-1ring-gray-200">
                    ...
                    @forelse ($this->tickets as $ticket)
                        <tr wire:key="ticket-{{ $ticket->id }}"
                            ...
                            <td class="whitespace-nowrap px-6 py-4 text-sm">
                                ...
                                @else
                                    <span class="inline-flex rounded-full px-3 py-1 text-xs
                                     font-semibold {{ $ticket->statusBadgeClasses() }}">
                                        {{ $ticket->statusLabel() }}
                                    </span>
                                @endif
                            </td>
                            <td class="whitespace-nowrap px-6 py-4 text-sm">
                                ...
                                @else
                                    <span class="inline-flex rounded-full px-3 py-1 text-xs
                                     font-semibold {{ $ticket->priorityBadgeClasses() }}">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex flex-wrap gap-2">
                                    ...
                                    <button
                                        ...
                                        class="inline-flex items-center rounded-lg border border-yellow-200
                                        bg-yellow-50 px-3 py-2 text-xs font-medium text-yellow-700
                                         transition hover:bg-yellow-100 disabled:cursor-not-allowed disabled:opacity-50"
                                    >
                                        In behandeling
                                    </button>
                                    <button
                                        ...
                                        class="inline-flex items-center rounded-lg border border-green-200
                                        bg-green-50 px-3 py-2 text-xs font-medium text-green-700 transition
                                        hover:bg-green-100 disabled:cursor-not-allowed disabled:opacity-50"
                                    >
                                        Gesloten
                                    </button>
                                </div>
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex justify-end gap-3">
                                    ...
                                    @else
                                        <button
                                            ...
                                            class="inline-flex items-center rounded-lg border border-indigo-300
                                             bg-indigo-50 px-3 py-2 text-xs font-medium text-indigo-700
                                             shadow-sm transition hover:bg-indigo-100"
                                        >
                                            Inline edit
                                        </button>
                                    @endif
                                    <a
                                        href="{{ route('tickets.show', $ticket) }}"
                                        class="inline-flex items-center rounded-lg border border-gray-300
                                        bg-white px-3 py-2 text-xs font-mediumtext-gray-700 shadow-sm
                                         transition hover:bg-gray-50"
                                    >
                                        Openen
                                    </a>
                                    <button
                                        ...
                                        class="inline-flex items-center rounded-lg bg-red-600 px-3 py-2

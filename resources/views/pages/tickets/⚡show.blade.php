...
if ($oldSubject !== $validated['subject']) {
    $changes[] = "Onderwerp gewijzigd van '{$oldSubject}' naar
'{$validated['subject']}'."; // NIEUW: beschrijf expliciet de wijziging van het onderwerp
}
...
if ($oldStatus !== $validated['status']) {
    $changes[] = "Status gewijzigd van '{$oldStatus}' naar
'{$validated['status']}'."; // NIEUW: statuswijziging apart loggen omdat die vaak belangrijk is in een workflow
}
if ($oldPriority !== $validated['priority']) {
    $changes[] = "Prioriteit gewijzigd van '{$oldPriority}' naar
'{$validated['priority']}'."; // NIEUW: prioriteitswijziging apart loggen voor historiek en opvolging
}
if (! empty($changes)) {

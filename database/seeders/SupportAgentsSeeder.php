...
use App\Models\User; // nodig om users aan te maken
use Illuminate\Database\Seeder; // basis seeder
use Illuminate\Support\Facades\Hash; // nodig om wachtwoorden te hashen
    ...
    public function run(): void
    {
        User::updateOrCreate(
            ...
            [
                ...
                'password' => Hash::make('password'), // //NIEUW: testwoordtwach
            ]
        );
        User::updateOrCreate(
